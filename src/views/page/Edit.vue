    ...
    >
      ...
      >
        <div class="flex flex-wrap -mx-3 mt-3 mb-6 max-w-3xl">
          <div id="page-edit-media" class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            <label
        ...
        <div class="flex flex-wrap -mx-3 mt-2 mb-6 max-w-3xl">
          <div id="page-edit-type" class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            <label
              class="block uppercase tracking-wide text-gray-700 text-md font-bold mb-2"
              for="grid-first-name"
            >
        ...
        <div class="flex flex-wrap -mx-3 mt-2 mb-6 max-w-3xl">
          <div id="page-edit-pageNum" class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            <label
              class="block uppercase tracking-wide text-gray-700 text-md font-bold mb-2"
              for="grid-first-name"
            >
        ...
        <div>
          <div class="max-w-xl mt-3">
            <p id="page-edit-image" class="font-bold text-gray-700">
              Page Image :
            </p>
            <label
...
export default {
	...
	methods: {
        ...
        async fetchPage () {
			this.page = await Page.getDocument(['comics', this.$route.params.comicId, 'chapters', this.$route.params.chapterId, 'pages'], this.$route.params.pageId)
			if (this.page.page_image_url) {
				this.page.page_image_url = await utils.getDataUrlFromStorage(this.page.page_image_url).then((cover) => {
		...
		async submitData () {
            ...
            console.log('asdfasdf')
						await this.page.adminUploadField('page_image_url', 'pages/' + this.page.id, this.coverImage)
					} catch (err) {
						await this.page.deleteDocument()
...
<script setup>
const titleStack = ref(['Admin', 'Page', 'Edit'])
</script>
